	...
	<div class="row-fluid">
		<div class="span10 form-horizontal">
			<fieldset>
				...
				<?php echo JHtml::_('bootstrap.addPanel', 'myTab', 'details', empty($this->item->id) ? JText::_('COM_TTLIVESCORE_NEW_CLUB', true) : JText::sprintf('COM_TTLIVESCORE_EDIT_CLUB', $this->item->id, true)); ?>
