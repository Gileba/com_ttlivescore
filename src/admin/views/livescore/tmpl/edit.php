...
<form action="<?php echo JRoute::_('index.php?option=com_ttlivescore&view=livescore&layout=edit&id=' . (int) $this->item->id); ?>" method="post" 
	name="adminForm" id="adminForm" class="form-validate ttlivescore">
	<div class="row-fluid">
				...
				<div class="span6 form-horizontal pull-right center">
						...
						for ($i = 1; $i <= $this->set; $i++)
						{
							...
							<div class="span12" style="margin-left: 0px;">
								...
								<button 
									onclick="document.getElementById('<?php echo 'jform_' . $points; ?>').value--;
										Joomla.submitbutton('livescore.apply');" 
