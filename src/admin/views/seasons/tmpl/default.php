...
<form action="<?php echo JRoute::_('index.php?option=com_ttlivescore&view=seasons'); ?>" method="post" name="adminForm" id="adminForm">
	...
	<div id="filter-bar" class="btn-toolbar">
		...
		<div class="btn-group pull-left">
			...
			<button 
				class="btn hasTooltip" type="button" title="<?php echo JText::_('JSEARCH_FILTER_CLEAR'); ?>"
				...
				<tr class="row<?php echo $i % 2; ?>" sortable-group-id="1">
					...
					<td class="center">
						<div class="btn-group">
							...
							if ($canChange)
								{
								echo JHtml::_('jgrid.published', $item->published, $i, 'seasons.', $canChange, 'cb', $item->publish_up,
									$item->publish_down
								);
								JHtml::_('actionsdropdown.' . ((int) $item->published === 2 ? 'un' : '') . 'archive', 'cb' . $i, 'seasons');
